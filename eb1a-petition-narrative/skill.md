...
1. **Case Setup** — Gather petition details and document index
2. **Exhibit Table** — Map documents to exhibits by criterion
3. **Evidence Enrichment** — Research entities, build source registry
...
1. **Petitioner** — company/organization filing, OR self-petition (beneficiary can self-petition for EB-1A)
2. **Beneficiary** — full legal name, alternate names, nationality
3. **Field of endeavor** — specific field label used throughout the letter
4. **Proposed U.S. work** — what the beneficiary will do in the U.S. (required for "continue to work" element)
5. **Which criteria are being argued** — must meet at least 3 of 10
6. **Document index location** — from document-summary-arrangement
